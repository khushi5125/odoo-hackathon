...
const menuItems = [
  ...
  { text: 'Leave', icon: <EventNote />, path: '/leave' },
  { text: 'Payroll', icon: <Payments />, path: '/payroll', roles: ['admin', 'hr'] },
  { text: 'Performance', icon: <Assessment />, path: '/performance', roles: ['admin', 'hr'] },
